...
public class ConfirmaPromoController extends GenericForwardComposer {
	...
	public void onClick$btn_sim(ForwardEvent e){
		Promocao o =  (Promocao) com.getValue();
	   	 new PromocaoDao().delete(o);
		 Clients.showNotification("Promocao removida com sucesso!");
		 List <Subpaginas>li = new SubpaginasDao().findAll();
		   	Subpaginas sub = new Subpaginas();
		    sub = li.get(0);
		    sub.setAreaGestor("pr");
